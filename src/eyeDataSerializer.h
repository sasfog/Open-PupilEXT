...
public:
    ...
    static QString getHeaderCSV(int procMode, QChar delim, DataWriterDataStructure dataStructure);
    
    static QString pupilToRowCSV(quint64 timestamp, int procMode, const std::vector<Pupil> &Pupils, const QString &filepath, uint trialNum, QChar delim, DataWriterDataStructure dataStructure, const std::vector<double> &temperatures);
