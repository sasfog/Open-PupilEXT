...
private: 
    ...
    enum PossArgsEnum {
        ...
        SET_HARDWARE_TRIGGERING_FRAMERATE_LIMITING_ENABLED,
        SET_HARDWARE_TRIGGERING_FRAMERATE_LIMIT,
    ...
    const std::vector<PossArgs> possArgList = {
        ...
        {SET_HARDWARE_TRIGGERING_FRAMERATE_LIMITING_ENABLED, "-setHardwareTriggeringFramerateLimitingEnabled", 1},
        {SET_HARDWARE_TRIGGERING_FRAMERATE_LIMIT, "-setHardwareTriggeringFramerateLimit", 1},
