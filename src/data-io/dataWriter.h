...
enum DataWriterDataStyle {
    //PUPILEXT_V0_1_1 = 1, // would need to contain filename field, but that is deprecated now
    //PUPILEXT_V0_1_2 = 2,
    DATASTYLE_V3 = 3
};
...
public:
    ...
    // TODO: make pupildetection singleton at last
    explicit DataWriter(
        const QString& fileName, 
        PupilDetection *pupilDetection = nullptr,
