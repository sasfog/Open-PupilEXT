...
#include "singleCameraCalibrationView.h"

// Create a single camera calibration widget
// Given a single camera from which its the calibration process is accessed
SingleCameraCalibrationView::SingleCameraCalibrationView(SingleCamera *camera, QWidget *parent): QWidget(parent), camera(camera), calibrationHelpDialog(new CalibrationHelpDialog(this)) {
...
SingleCameraCalibrationView::~SingleCameraCalibrationView() {
...
void SingleCameraCalibrationView::onCalibrateClick() {
...
void SingleCameraCalibrationView::onVerifyClick() {
...
void SingleCameraCalibrationView::onCalibrationFinished() {
    // this gets called on calibration and verify
    verifyButton->setDisabled(false);
    stopButton->setDisabled(true);
}

void SingleCameraCalibrationView::onStopClick() {
...
void SingleCameraCalibrationView::onCheckboxClick() {
...
void SingleCameraCalibrationView::onSaveClick() {
...
// File is in the OpenCV XML filestorage fileformat
void SingleCameraCalibrationView::onLoadClick() {
...
void SingleCameraCalibrationView::closeEvent(QCloseEvent *event) {
...
void SingleCameraCalibrationView::onSizeBoxChange() {
...
void SingleCameraCalibrationView::onSharpnessThresholdBoxChange() {

    calibrationWorker->setSharpnessThreshold(sharpnessThresholdBox->value());
}

void SingleCameraCalibrationView::updateSettings() {
...
void SingleCameraCalibrationView::onShowHelpDialog() {

    calibrationHelpDialog->show();
}

// Set an output path for saving the verification file in the csv file format
void SingleCameraCalibrationView::onVerifyFileChecked(bool value) {
