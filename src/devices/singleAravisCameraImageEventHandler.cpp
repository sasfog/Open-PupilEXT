...
SingleAravisCameraImageEventHandler::SingleAravisCameraImageEventHandler(QObject* parent) : QObject(parent), cameraTime(0), systemTime(0) {
    // Set the image mode to 8 bit grayscale
//    formatConverter.OutputPixelFormat = Pylon::PixelType_Mono8;
}

SingleAravisCameraImageEventHandler::~SingleAravisCameraImageEventHandler() {

}

/*
void SingleAravisCameraImageEventHandler::OnImagesSkipped(CInstantCamera& camera, size_t countOfSkippedImages) {
...
/*
void SingleAravisCameraImageEventHandler::OnImageGrabbed(CInstantCamera& camera, const CGrabResultPtr& ptrGrabResult) {
...
void SingleAravisCameraImageEventHandler::setTimeSynchronization(uint64 m_cameraTime, uint64 m_systemTime) {
...
void SingleAravisCameraImageEventHandler::stream_callback (void *user_data, ArvStreamCallbackType type, ArvBuffer *buffer) {
